...
import com.changgou.oauth.pojo.OauthClientDetails;
import com.changgou.oauth.service.OauthClientDetailsService;
...
public class OauthClientDetailsController {
    ...
    public Result add(){
        ...
        oauthClient.setClientId("changgou");
        oauthClient.setAccessTokenValidity(60*1000);
        oauthClient.setRefreshTokenValidity(60*1000);
        oauthClient.setClientSecret(new BCryptPasswordEncoder().encode("changgou"));
        oauthClient.setWebServerRedirectUri("http://localhost");
        oauthClient.setScope("app");
        oauthClientDetailsService.add(oauthClient);
        return new Result(true,StatusCode.OK,"添加客户端信息成功");
    }
