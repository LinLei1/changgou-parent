...
public class SpuServiceImpl implements SpuService {
    ...
    public void putMany(Long[] ids) {
        ...
        /*for (Long id: ids) {
            ...
            if (spu.getIsDelete().equalsIgnoreCase("1")){
                throw new RuntimeException("不能对已删除的商品上架!");
            }
            if (spu.getStatus().equalsIgnoreCase("0")){
                throw new RuntimeException("不能未审核的商品上架!");
            }
            //实现下架
            spu.setIsMarketable("1");  //表示上架
    ...
    public void pull(Long spuId) {
        ...
        //判断商品是否已删除
        if (spu.getIsDelete().equalsIgnoreCase("1")){
            throw new RuntimeException("不能对已删除的商品下架!");
        }
        //实现下架
        spu.setIsMarketable("0");  //表示上架
        spuMapper.updateByPrimaryKeySelective(spu);
    }
    ...
    public void saveGoods(Goods goods) {
        ...
        for (Sku sku : skuList) {
            ...
            //获取spec的值{"电视音响效果":"立体声","电视屏幕尺寸":"20英寸","尺码":"156"}
    ...
    public Example createExample(Spu spu){
        ...
        if(spu!=null){
            ...
            // 评论数
            if(!StringUtils.isEmpty(spu.getCommontNum())){
                    criteria.andEqualTo("commontNum",spu.getCommontNum());
            }
            // 是否上架
