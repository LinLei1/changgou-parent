...
import com.changgou.oauth.dao.OauthClientDetailsMapper;
...
public class OauthClientDetailsServiceImpl implements OauthClientDetailsService {
    ...
    public Example createExample(OauthClientDetails oauthClientDetails){
        ...
        if(oauthClientDetails!=null){
            ...
            // 
            if(!StringUtils.isEmpty(oauthClientDetails.getResoucesIds())){
                    criteria.andEqualTo("resoucesIds",oauthClientDetails.getResoucesIds());
            }
            // 客户端密钥,BCryptPasswordEncoder加密算法加密
            ...
            if(!StringUtils.isEmpty(oauthClientDetails.getWebServerRedirectUri())){
                    criteria.andEqualTo("webServerRedirictUri",oauthClientDetails.getWebServerRedirectUri());
            }
            // 
